...
// Create the modal structure function
...
// Replace the time click event handler
document.querySelector(".rooms-control").addEventListener("click", (e) => {
...
// Handle the Add Room dropdown toggle
...
// Add Room functionality (use your existing code)
...
// Turn On All ACs button - Enhanced with visual feedback
document.getElementById("turnOnAll").addEventListener("click", () => {
  ...
  // Display a brief toast message (create a toast function)
...
// Add this to your CSS via another script element
